  ...
  return (
    <div className="bg-white">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm">200 Ratings</p>
                  <p className="ml-3 text-sm text-sm">200 Reviews</p>
                </div>
              </div>
        ...
        {/* Rating Reviews */}
        <h1 className="text-lg pb-4">Review</h1>
        <section>
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid items xs={5}>
                <h1 className="text-xl pb-2">Product Rating</h1>
                <div className="flex items-center space-x-3">
                  <Rating
                    name="read-only"
                    value={4.5}
        ...
        <section className="pt-10">
                    <h1 className="py-5 m-3text-xl ">Similar Products</h1>
                    <div className="flex flex-wrap space-y-5">
                         {product.images.map((item)=><HomeSectionCard product={item}/>)}                    
                    </div>
        </section>
      </div>
    </div>
